...
proc create_root_design { parentCell } {
  ...
  set PWM_blue [ create_bd_port -dir O -from 0 -to 0 PWM_blue ]
  set PWM_green [ create_bd_port -dir O -from 0 -to 0 PWM_green ]
  set PWM_red [ create_bd_port -dir O -from 0 -to 0 PWM_red ]
  ...
  set PWM_w_Int_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:PWM_w_Int:1.0 PWM_w_Int_1 ]

  # Create instance: PWM_w_Int_2, and set properties
  set PWM_w_Int_2 [ create_bd_cell -type ip -vlnv xilinx.com:user:PWM_w_Int:1.0 PWM_w_Int_2 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M03_AXI [get_bd_intf_pins PWM_w_Int_1/S00_AXI] [get_bd_intf_pins axi_interconnect_0/M03_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M04_AXI [get_bd_intf_pins PWM_w_Int_2/S00_AXI] [get_bd_intf_pins axi_interconnect_0/M04_AXI]
  ...
  connect_bd_net -net PWM_w_Int_1_LEDs [get_bd_pins PWM_w_Int_1/LEDs] [get_bd_pins xlslice_1/Din]
  connect_bd_net -net PWM_w_Int_2_LEDs [get_bd_pins PWM_w_Int_2/LEDs] [get_bd_pins xlslice_2/Din]
  ...
  connect_bd_net -net clk_0_1 [get_bd_ports clk_0] [get_bd_pins PWM_w_Int_0/s00_axi_aclk] [get_bd_pins PWM_w_Int_1/s00_axi_aclk] [get_bd_pins PWM_w_Int_2/s00_axi_aclk] [get_bd_pins axi2wb_intcon_wrapper_0/clk_i_wrapper] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins bootrom_wrapper_0/i_clk] [get_bd_pins ptc_wrapper_0/wb_clk_i] [get_bd_pins swerv_wrapper_verilog_0/clk] [get_bd_pins syscon_wrapper_0/i_clk] [get_bd_pins wb_gpio_wrapper_0/wb_clk_i] [get_bd_pins wb_spi_wrapper_0/wb_clk_i] [get_bd_pins wb_uart_wrapper_0/wb_clk_i]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_ports PWM_red] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_ports PWM_green] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_ports PWM_blue] [get_bd_pins xlslice_2/Dout]
  ...
  assign_bd_address -offset 0x80140000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi2wb_intcon_wrapper_0/o_user_axi4] [get_bd_addr_segs PWM_w_Int_1/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x80150000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi2wb_intcon_wrapper_0/o_user_axi4] [get_bd_addr_segs PWM_w_Int_2/S00_AXI/S00_AXI_reg] -force
