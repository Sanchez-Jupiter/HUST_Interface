...
//Date        : Thu Oct 10 08:43:25 2024
//Host        : LHYsPC running 64-bit major release  (build 9200)
//Command     : generate_target design_1swerv_soc.bd
//Design      : design_1swerv_soc
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "design_1swerv_soc,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1swerv_soc,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=5,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=2,numPkgbdBlks=0,bdsource=USER,da_clkrst_cnt=3,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1swerv_soc.hwdef" *) 
module design_1swerv_soc
   (AN_0,
    Digits_Bits_0,
    bidir,
    clk_0,
  ...
  output [31:0]bidir;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_0, ASSOCIATED_BUSIF ram, ASSOCIATED_RESET rst_0, CLK_DOMAIN design_1swerv_soc_clk_0, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000" *) input clk_0;
  ...
  design_1swerv_soc_axi2wb_intcon_wrapper_0_0 axi2wb_intcon_wrapper_0
       (.clk_i_wrapper(clk_0_1),
        ...
        .wb_uart_err_i(1'b0),
        .wb_uart_rty_i(1'b0));
  design_1swerv_soc_bootrom_wrapper_0_0 bootrom_wrapper_0
       (.i_clk(clk_0_1),
        .i_rst(rst_0_1),
  ...
  design_1swerv_soc_swerv_wrapper_verilog_0_0 swerv_wrapper_verilog_0
       (.clk(clk_0_1),
  ...
  design_1swerv_soc_syscon_wrapper_0_0 syscon_wrapper_0
       (.AN(syscon_wrapper_0_AN),
        ...
        .ptc_irq(1'b0));
  design_1swerv_soc_wb_gpio_wrapper_0_0 wb_gpio_wrapper_0
