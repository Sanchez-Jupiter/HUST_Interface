...
##set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { PWMs_red[1] }]
set_property -dict { PACKAGE_PIN M16   IOSTANDARD LVCMOS33 } [get_ports { PWM_green }]
##set_property -dict { PACKAGE_PIN R11   IOSTANDARD LVCMOS33 } [get_ports { PWMs_green[1] }]
set_property -dict { PACKAGE_PIN R12   IOSTANDARD LVCMOS33 } [get_ports { PWM_blue }]
##set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { PWMs_blue[1] }]
...
temp_sensor_sda_io }]; #IO_L1N_T1_mrcc_15 Sch=tmp_sda