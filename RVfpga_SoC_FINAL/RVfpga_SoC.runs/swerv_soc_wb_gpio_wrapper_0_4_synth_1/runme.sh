...
HD_PWD='D:/MIPSfpga_Fundamentals/Xilinx/VivadoProject/RVfpga_SoC/RVfpga_SoC.runs/swerv_soc_wb_gpio_wrapper_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log swerv_soc_wb_gpio_wrapper_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source swerv_soc_wb_gpio_wrapper_0_4.tcl
